...
- I pulled 10 studies, 7 countries, around 1,500 people, and trained machine-learning models with strict cross-cohort validation.
...
- I pulled around 1,500 people across 10 published cohorts in 7 countries, all shotgun-sequenced, and ran machine-learning models with leave-one-dataset-out cross-validation. So every test cohort is one the model has never seen.
