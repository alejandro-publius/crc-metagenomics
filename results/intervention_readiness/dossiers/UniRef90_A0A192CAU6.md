...
- **Candidate ID:** `UniRef90_A0A192CAU6`
- **Class:** precision_address_candidate
- **Current atlas status:** rejected_no_parent_independent_signal

## Why it is in the atlas

selected in 10 outer folds; 80% held-out direction consistency; median held-out AUC 0.608
...
did not pass: median held-out AUC gain 0.002; positive in 60% of evaluable folds
