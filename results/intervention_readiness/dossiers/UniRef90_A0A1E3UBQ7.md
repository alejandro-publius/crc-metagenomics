...
- **Candidate ID:** `UniRef90_A0A1E3UBQ7`
- **Class:** precision_address_candidate
- **Current atlas status:** rejected_no_parent_independent_signal

## Why it is in the atlas

selected in 7 outer folds; 100% held-out direction consistency; median held-out AUC 0.558
...
did not pass: median held-out AUC gain 0.005; positive in 60% of evaluable folds
