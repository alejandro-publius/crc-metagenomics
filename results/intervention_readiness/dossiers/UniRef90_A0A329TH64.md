...
- **Candidate ID:** `UniRef90_A0A329TH64`
- **Class:** precision_address_candidate
- **Current atlas status:** rejected_no_parent_independent_signal

## Why it is in the atlas

selected in 10 outer folds; 80% held-out direction consistency; median held-out AUC 0.611
...
did not pass: median held-out AUC gain 0.015; positive in 60% of evaluable folds
