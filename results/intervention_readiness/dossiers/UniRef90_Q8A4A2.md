...
- **Candidate ID:** `UniRef90_Q8A4A2`
- **Class:** precision_address_candidate
- **Current atlas status:** rejected_no_parent_independent_signal

## Why it is in the atlas

selected in 8 outer folds; 88% held-out direction consistency; median held-out AUC 0.580
...
did not pass: median held-out AUC gain 0.002; positive in 50% of evaluable folds
