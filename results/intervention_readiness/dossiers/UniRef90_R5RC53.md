...
- **Candidate ID:** `UniRef90_R5RC53`
- **Class:** precision_address_candidate
- **Current atlas status:** rejected_mixed_taxonomic_sources

## Why it is in the atlas

selected in 10 outer folds; 80% held-out direction consistency; median held-out AUC 0.591
...
The family carries parent-independent CRC signal, but its abundance is distributed across multiple taxa; it is not a direct editing address.

## Address-resolution detail

median held-out AUC gain 0.038; positive in 70% of evaluable folds

dominant carrier g__Bacteroides.s__Bacteroides_uniformis accounted for 13.5% across 23 detected taxa
