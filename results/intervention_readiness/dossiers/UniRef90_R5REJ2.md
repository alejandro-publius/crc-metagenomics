...
- **Candidate ID:** `UniRef90_R5REJ2`
- **Class:** precision_address_candidate
- **Current atlas status:** rejected_mixed_taxonomic_sources

## Why it is in the atlas

selected in 10 outer folds; 80% held-out direction consistency; median held-out AUC 0.588
...
median held-out AUC gain 0.021; positive in 70% of evaluable folds

dominant carrier g__Bacteroides.s__Bacteroides_ovatus accounted for 24.3% across 15 detected taxa
