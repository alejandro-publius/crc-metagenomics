...
- **Candidate ID:** `UniRef90_R5U7X9`
- **Class:** precision_address_candidate
- **Current atlas status:** rejected_no_parent_independent_signal

## Why it is in the atlas

selected in 7 outer folds; 100% held-out direction consistency; median held-out AUC 0.575
...
did not pass: median held-out AUC gain 0.004; positive in 50% of evaluable folds
