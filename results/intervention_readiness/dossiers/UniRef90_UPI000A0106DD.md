...
- **Candidate ID:** `UniRef90_UPI000A0106DD`
- **Class:** precision_address_candidate
- **Current atlas status:** rejected_no_parent_independent_signal

## Why it is in the atlas

selected in 7 outer folds; 86% held-out direction consistency; median held-out AUC 0.555
...
| Signal beyond annotated parent species | not_passed |
| Taxon-resolved carrier | not_yet_assessed |
| Biological function or harmful-clade link | not_assessed_parent_gate_failed |
...
The family recurs across cohorts but does not add enough held-out information beyond its annotated parent-species proxy.

## Address-resolution detail

did not pass: median held-out AUC gain 0.014; positive in 60% of evaluable folds
