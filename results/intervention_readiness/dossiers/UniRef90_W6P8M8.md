...
- **Candidate ID:** `UniRef90_W6P8M8`
- **Class:** precision_address_candidate
- **Current atlas status:** rejected_mixed_taxonomic_sources

## Why it is in the atlas

selected in 10 outer folds; 80% held-out direction consistency; median held-out AUC 0.594
...
median held-out AUC gain 0.043; positive in 70% of evaluable folds

dominant carrier g__Bacteroides.s__Bacteroides_ovatus accounted for 20.8% across 12 detected taxa
