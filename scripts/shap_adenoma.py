...
adenoma-vs-CRC). Scope: model is fit on the full per-task subset across
all available cohorts; SHAP values describe feature importance for the
fitted classifier, not cross-cohort generalization. The cross-cohort
adenoma LODO results in adenoma_lodo.py show the healthy-vs-adenoma
signal does not generalize across cohorts (mean LODO AUC ~0.56-0.58),
