...
Scope: the model is fit on the entire labeled CRC + control set (n = 1,339
across 10 cohorts) and SHAP values are computed on that same fit. These
values describe how the fully-fit model uses each feature; they do NOT
measure what drives generalization across cohorts. The headline
generalization claim comes from LODO in train_baseline.py / train_joint.py.
